...
//        amountEt.setText(stuffs);
    ...
    void payUsingUpi(String amount, String upiId, String name, String note) {
        Uri uri = new Uri.Builder()
                ...
                .appendQueryParameter("mc", "BCR2DN4T7CKL362")//BCR2DN6T56ONTVZQ
                .appendQueryParameter("tr", "2520904455")
...
//                .appendQueryParameter("pn", name)
//                .appendQueryParameter("tn", note)
//                .appendQueryParameter("mc", "BCR2DN6T56ONTVZQ")
//                .appendQueryParameter("tr", "250120220904455")
//                .appendQueryParameter("am", amount)
//                .appendQueryParameter("cu", "INR")
//                .appendQueryParameter("url", "")
//                .build();
